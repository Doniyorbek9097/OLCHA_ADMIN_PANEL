<template>
    <q-drawer :model-value="modelValue"  :class="$q.dark.isActive ? 'bg-black text-white' : 'bg-white text-black'"
      ...
      <q-list bordered separator padding>
        <q-item :to="{ name: 'IndexPage' }" active-class="q-item-no-link-highlighting">
        ...
        <q-expansion-item expand-separator icon="category" label="Categories">
          <q-list padding>
            <q-item :inset-level=".5" active-class="q-item-no-link-highlighting" :to="{ name: 'Categories' }">
            ...
            <q-item :inset-level=".5" active-class="q-item-no-link-highlighting" :to="{ name: 'SubCategories' }">
              <q-item-section avatar><q-icon name="arrow_outward"></q-icon></q-item-section>
              <q-item-section>
            ...
            <q-item :inset-level=".5" active-class="q-item-no-link-highlighting" :to="{ name: 'ChildCategories' }">
              <q-item-section avatar><q-icon name="arrow_outward"></q-icon></q-item-section>
              <q-item-section>
        ...
        <q-expansion-item expand-separator icon="local_mall" label="Products">
          <q-list bordered>
            <q-item :inset-level=".5" active-class="q-item-no-link-highlighting" :to="{ name: 'Products' }">
              <q-item-section avatar><q-icon name="arrow_outward"></q-icon></q-item-section>
              <q-item-section>
            ...
            <q-item :inset-level=".5" active-class="q-item-no-link-highlighting" :to="{ name: 'Carousel' }">
              <q-item-section avatar><q-icon name="arrow_outward"></q-icon></q-item-section>
              <q-item-section>
                <q-item-label>Carousel Banner</q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
        </q-expansion-item>
