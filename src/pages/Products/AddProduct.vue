          ...
          <q-form @submit.prevent="$refs.stepper.next()">
            <div class="row">
              ...
              <div class="col-md-12 col-12 q-py-sm">
                <q-item-label class="q-pa-xs">Mahsulotning asosiy rasmini tanlang majburiy*</q-item-label>
                <file-uploader :width="405" :height="540" required v-model="productStore.product.mainImage" ref="mainImage" label="Mahsulotning asosiy rasmi" />
              </div>
            ...
            <q-stepper-navigation>
              ...
              <q-btn type="submit" color="primary" icon-right="navigate_next" label="Oldinga" class="q-ml-sm"/>
            </q-stepper-navigation>
          </q-form>
        </q-step>
        ...
        <q-step :name="2" title="Mahsulot brendi haqida" caption="brend sozlamasi" icon="create_new_folder"
          ...
          <q-form @submit.prevent="$refs.stepper.next()">
            <div class="row">
              ...
              <div class="col-md-12 col-12 q-py-sm">
                <q-item-label class="q-pa-xs">Mahsulotning Brend logosi majburiy*</q-item-label>
                <file-uploader v-model="productStore.product.brend.image" label="Brend logosi" />
              </div>
            ...
            <q-stepper-navigation>
              <q-btn type="button" color="red" icon="undo" label="Orqaga" @click="step = 1" />
              <q-btn type="submit" color="primary" icon-right="navigate_next" label="Oldinga" class="q-ml-sm"/>
            </q-stepper-navigation>
          </q-form>
        </q-step>
        ...
        <q-step :name="3" title="Boshqa malumotlar" icon="add_comment">
          ...
          <q-form @submit.prevent="$refs.stepper.next()">
            <div class="row">
              ...
              <div class="col-12 q-py-sm">
                <q-item-label class="q-pa-sm">Mahsulotning barcha rasmlari</q-item-label>
                <FileUploader v-model="productStore.product.images" multiple/>
              </div>
          ...
          <q-stepper-navigation>
             <q-btn type="button" color="red" icon="undo" label="Orqaga" @click="step = 2" />
             <q-btn type="submit" color="primary" icon-right="navigate_next" label="Saqlash" class="q-ml-sm" @click.prevent="productStore.addProduct(productStore.product);"/>
          </q-stepper-navigation>
        </q-step>
      </q-stepper>
    </div>
...
import DiynamicInput from '../../components/DiynamicInput.vue';
